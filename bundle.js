...
Choreographic Coding Lab Online is a series of events organized and curated by Naoto Hieda as an official unconference at <a href="https://20.nodeforum.org/">NODE20</a>. Open to everyone and festival pass is not required to join :)
    ...
    <p>
Here is an "official" link for a proper festival-goer:
    </p>
...
<div class="rowimg">
    ...
    <p>
Here is "unofficial" yet official information:
    </p>
...
<div class="youtube-container"><iframe class="youtube-video" width="560" height="315" src="https://www.youtube.com/embed/7ioV6D_OStY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
      `
    },
    {
