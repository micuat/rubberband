...
module.exports = () => {
  ...
  const lfsdesc = html`Lunch session. URL coming soon.<b></b>`;
  ...
  const sc = [
    {start: new Date("October 2, 2020 17:30:00 UTC"), end: new Date("October 2, 2020 19:00:00 UTC"), title: "Creative Code Stammtisch", orgs: html`Creative Code Berlin`, type: ["meetup"], desc: html`*this event is hosted by <a href="https://www.meetup.com/creativeCodeBerlin/">Creative Code Berlin</a>*<br>Naoto gives a brief introduction at the Stammtisch. <a href="https://www.meetup.com/creativeCodeBerlin/events/skjgrrybcnbdb/">More info here.</a>`},
    {start: new Date("October 3, 2020 10:30:00 UTC"), end: new Date("October 3, 2020 11:30:00 UTC"), title: "Low Frequency Skies", orgs: lfsorgs.cloneNode(true), desc: lfsdesc.cloneNode(true)},
  ...
  for(let i = 0; i < sc.length; i++) {
    ...
    dates.push(html`<li><p class="schedule">${start} - ${end}</p><p class="title">${title}</p><p class="type">${types}</p><p class="orgs">by ${orgs}</p><p class="desc">${desc}</p></li>`);
  }
