...
module.exports = function(state, emit) {
  ...
  for(var i = 0; i < state.profiles.length; i++) {
    ...
    participants.push(html`<span class="participant ${badge}"><a href="/introductions/${i+1}" style="background-color:hsl(${Math.floor(360* i/state.profiles.length)}, 100%, 90%)">${profile["Your name"]}</a></span> `);
  }
